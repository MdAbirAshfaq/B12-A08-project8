...
const Banner = () => {
    ...
    return (
        <div className='text-center bg-[#F5F5F5] pt-[60px] '>
            ...
            <div className='mt-4' >
                <button onClick={openGooglePlay} className='btn mr-3'><i class="fa-brands fa-google-play"></i>Google Play</button>
                <button onClick={openAppleStore} className='btn' ><i class="fa-brands fa-app-store-ios"></i>App Store</button>
            </div>
